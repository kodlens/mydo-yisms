...
import {
  ...
  MenuUnfoldOutlined,
  HomeOutlined,
  UserOutlined, LockOutlined, DownOutlined, AppstoreOutlined
...
export default function YouthAuthLayout(
  ...
  const navigationItems = useMemo<MenuItem[]>(() => ([
    ...
    },
    {
        ...
        onClick: () => router.visit('/youth/change-password')
          ...
          <div className='border-b border-cyan-100/20 pb-3'>
            ...
            {!collapsed && (
              <div className='mx-4 mt-1 rounded-xl border border-cyan-100/20 bg-white/10 px-3 py-2 text-cyan-50 backdrop-blur-[1px]'>
                  <p className='text-[10px] font-semibold uppercase tracking-[0.14em] text-cyan-100/90'>Youth PANEL</p>
            ...
            <div className='flex h-16 items-center justify-between px-3'>
              <div className='flex items-center gap-3'>
                ...
                <div className='leading-tight'>
                  <p className='text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-500'>Youth Workspace</p>
